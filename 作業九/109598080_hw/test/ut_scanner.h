...
TEST(Scanner, compoundshape) {
    Scanner scanner("CompoundShape {Rectangle (3.000, 4.000), Ellipse (4.000, 3.000), Triangle (0.000, 0.000, 3.000, 0.000, 0.000, 4.000)}");
...
TEST(Scanner, compoundshape_compoundshape) {
    Scanner scanner("CompoundShape {Rectangle (3.000, 4.000), Ellipse (4.000, 3.000), Triangle (0.000, 0.000, 3.000, 0.000, 0.000, 4.000) CompoundShape {Rectangle (3.000, 4.000), Ellipse (4.000, 3.000), Triangle (0.000, 0.000, 3.000, 0.000, 0.000, 4.000)}}");
    ASSERT_EQ("CompoundShape", scanner.nextToken());
    ASSERT_EQ("{", scanner.nextToken());
    ASSERT_EQ("Rectangle", scanner.nextToken());
    ASSERT_EQ("(", scanner.nextToken());
